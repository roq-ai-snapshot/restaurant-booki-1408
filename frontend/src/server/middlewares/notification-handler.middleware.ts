...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': {
    roles: ['restaurant-owner', 'restaurant-manager', 'wait-staff', 'chef'],
    key: 'order_id',
    tenantPath: [],
    userPath: [],
  },
  'table_booked.create': {
    roles: ['restaurant-owner', 'restaurant-manager', 'wait-staff'],
    key: 'table_id',
    tenantPath: [],
    userPath: [],
  },
  'inventory_updated.update': {
    roles: ['restaurant-owner', 'chef'],
    key: 'inventory_id',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['restaurant-owner'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['restaurant-owner', 'restaurant-manager', 'wait-staff', 'chef'];
